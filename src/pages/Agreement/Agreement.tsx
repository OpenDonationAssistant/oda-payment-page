...
function yookassa(nickname: string, fio: string, inn: string, email: string) {
  return (
    <div>
      ...
      <ol>
        ...
        <li>
          Сумма дарения денежных средств определяется донором в приложении к
          оферте.
        </li>
        <li>
        ...
        <li>
          Датой акцепта оферты и датой заключения договора дарения является дата
          поступления денежных средств донора на расчетный счет
        </li>
        <li>
          Оферта вступает в силу со дня публикации на сайте{" "}
          {window.location.hostname}. В оферту могут быть внесены изменения и
...
function robokassa(fio: string, inn: string, email: string) {
  return (
    <>
      ...
      <ol>
        ...
        <li>
          Стороны соглашаются, что для любых возникающих между ними споров
          обязательным является предварительный претензионный порядок.
        </li>
        <li>
          Стороны соглашаются, что любые споры между ними подсудны
          соответствующему суду по месту нахождения блогера.
        </li>
    ...
    <div className="h-100 d-flex align-items-center justify-content-center">
      ...
      <div className="card shadow-lg rounded">
        <div className="card-header pb-4 pt-4 ps-4 align-middle">
          {gateway === "yookassa" && yookassa(nickname, fio, inn, email)}
          ...
          <ol>
            ...
            <li>
              ...
              Analytics. Используя и взаимодействуя с сайтом{" "}
              {window.location.hostname}
              пользователь соглашается с условиями использования YouTube API
              Services (
